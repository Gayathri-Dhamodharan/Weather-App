...
const WeatherCard = ({ Dataofweathercard }) => {
  ...
  return (
    <div
      className={`flex flex-col lg:flex-row h-[100%]  lg:mb-4  lg:w-full lg:h-[25%] md:bg-black/20 rounded-xl  ${roboto.className}`}
    >
      ...
      <div className="flex flex-row justify-around lg:justify-evenly  items-center lg:w-2/3 w-full">
        ...
        <div className="flex flex-col items-center  ">
          ...
          <p className=" text-xs lg:text-xl mt-1 text-white/80">
