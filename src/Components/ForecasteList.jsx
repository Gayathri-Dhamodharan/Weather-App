...
//   return (
//     <div
//       className={`relative bg-black/20 p-4 rounded-2xl shadow-lg w-full pt-10 ${roboto.className}`}
//     >
//       <h2 className="text-xl font-semibold mb-4 text-white/70">
//         Last 10 Days Weather
//       </h2>
...
//               {day.day}
//             </div>
//             <div className="text-center text-lg text-white/60 font-bold">
//               {day.temp}
//             </div>
//           </div>
//         ))}
...
const ForecasteList = ({ DataforforecasteList }) => {
  ...
  return (
    <div
      className={`relative bg-black/20 p-4 rounded-2xl shadow-lg pt-10 ${roboto.className}`}
    >
      <h2 className="text-xl font-semibold mb-4 text-white/70">
        Last 10 Days Weather
      </h2>
      ...
      >
        {foreCast.map((day, idx) => (
          <div
            key={idx}
            className="relative bg-black/30 p-8 pt-6 rounded-xl flex-shrink-0 w-[10%] min-w-[120px]"
          >
            {console.log(day, "ooo")}
